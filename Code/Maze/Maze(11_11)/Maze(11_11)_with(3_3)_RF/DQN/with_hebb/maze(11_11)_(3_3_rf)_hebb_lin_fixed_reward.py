# -*- coding: utf-8 -*-
"""maze(11*11)_(3*3_RF)_hebb_lin_fixed_reward.ipynb
...
class MazeEnv:
    ...
    def _get_observation(self):
        ...
        obs[1, 1] = 0.5  # Mark the agent's position

        if abs(self.reward_pos[0] - self.posr) <= 1 and abs(self.reward_pos[1] - self.posc) <= 1:
            obs[self.reward_pos[0] - self.posr + 1, self.reward_pos[1] - self.posc + 1] = 0.8
...
env = MazeEnv(labsize=13)
device = torch.device("cuda:7" if torch.cuda.is_available() else "cpu")

n_actions = 4  # Up, Down, Left, Right
n_observations = 3 * 3  # 3x3 grid
