# -*- coding: utf-8 -*-
"""maze(9*9)(5*5_RF)_hebb_lin_fixed_reward.ipynb
...
class MazeEnv:
    ...
    def _get_observation(self):
        ...
        obs[2, 2] = 0.5  # Mark the agent's position

        reward_row, reward_col = self.reward_pos
        if abs(reward_row - self.posr) <= 2 and abs(reward_col - self.posc) <= 2:
            obs[reward_row - self.posr + 2, reward_col - self.posc + 2] = 0.8
...
class DQN(nn.Module):
    def __init__(self, n_observations, n_actions):
        ...
        self.layer1 = ModulatedPlasticDense(n_observations, 200)
