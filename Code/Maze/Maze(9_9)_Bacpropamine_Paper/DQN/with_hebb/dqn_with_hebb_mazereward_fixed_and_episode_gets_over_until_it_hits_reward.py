# -*- coding: utf-8 -*-
"""dqn_with_hebb_mazereward fixed and episode gets over until it hits reward.ipynb
...
class MazeEnv:
    ...
    def reset(self):
        self.posr, self.posc = 1, 1
        return self._get_observation()

    def _get_observation(self):
        obs = np.copy(self.lab)
        obs[self.posr, self.posc] = 0.5
        obs[self.reward_pos[0], self.reward_pos[1]] = 0.8
        return obs
...
n_observations = env.LABSIZE * env.LABSIZE
