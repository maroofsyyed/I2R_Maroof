...
class A2CAgent:
    def __init__(self, input_size, n_actions, learning_rate=0.0001, gamma=0.99):
        self.device = device
        self.gamma = gamma
...
def train(env, agent, n_episodes=10000, max_steps=200):
    ...
    # Save CSV file
    with open('a2c_maze2.csv', 'w', newline='') as csvfile:
        csv_writer = csv.writer(csvfile)
        csv_writer.writerow(['Episode', 'Reward', 'Average Reward (last 100)'])
        csv_writer.writerows(csv_data)

    print("Training results saved to a2c_maze2.csv")
